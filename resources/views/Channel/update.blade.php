            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="POST" action='{{ route('channel.update', ['channel' => $channel]) }}'>
                            @method('PUT')
                            @csrf
                            <div class='form-group'>
                                <label for='title'>Title:</label>
                                <input type='text' class='form-control' name='title' value="{{ $channel->name }}" required>
                            </div>
    
                            <div class='form-group'>
                                <label for='slug'>Slug:</label>
                                <input type='text' class='form-control' name='slug' value="{{ $channel->slug }}" required>
                            </div>
